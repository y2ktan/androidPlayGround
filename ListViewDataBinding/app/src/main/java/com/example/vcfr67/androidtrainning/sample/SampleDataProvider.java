package com.example.vcfr67.androidtrainning.sample;
...
//    public static ObservableArrayList<DataItem> dataItemList;
//    public static ObservableMap<String, DataItem> dataItemMap;
    public ObservableArrayList<DataItem> dataItemList =
        new ObservableArrayList<>();
    public ObservableMap<String, DataItem> dataItemMap =
            new ObservableArrayMap<>();

    static {
        //dataItemList = new ObservableArrayList<>();
        //dataItemMap = new ObservableArrayMap<>();
...
//                3, 6, "cafe_latte.jpg"));
    ...
    public void remove(View v) {
        if (!dataItemList.isEmpty()) {
            dataItemMap.remove(dataItemList.get(0).getItemId());
            dataItemList.remove(0);
        }
    }
